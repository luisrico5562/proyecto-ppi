...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('disco.index')}}">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ID - {{$disco->id}}</h5>
                            ...
                            <form action="{{route('disco.update', $disco)}}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="nombre" type="text" class="form-control" value="{{$disco->nombre}}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="genero" type="text" class="form-control" value="{{$disco->genero}}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="year" type="text" class="form-control" value="{{$disco->year}}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="precio" type="text" class="form-control" value="{{$disco->precio}}">
                                    </div>
                                </div>
                            ...
                            <p></p>
                            <form action="{{route('disco.destroy', $disco)}}" method="POST">
                                @csrf
                                @method('DELETE')
                            ...
                            <p></p>
                            <a href="{{route('disco.show', $disco)}}">Cancelar</a>
