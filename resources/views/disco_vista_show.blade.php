...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="t#">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-4 label">Género:</div>
                                    <div class="col-lg-10 col-md-8">{{$disco->genero}}</div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-4 label">Año:</div>
                                    <div class="col-lg-10 col-md-8">{{$disco->year}}</div>
                                </div>

                                <br>

                                <div class="row">
                                    <div class="col-lg-2 col-md-4 label">Precio:</div>
                                    <div class="col-lg-10 col-md-8">{{$disco->precio}}</div>
                                </div>
                            ...
                            <p></p>
                            <a href="{{route('disco.index')}}">Regresar</a>
