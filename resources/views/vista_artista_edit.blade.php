        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ID - {{$artista->id}}</h5>
                            ...
                            <form action="{{route('Artista.update', $artista)}}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="nombre" type="text" class="form-control" value="{{$artista->nombre}}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="pais" type="text" class="form-control" value="{{$artista->pais}}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="descripcion" class="form-control" style="height: 100px">{{$artista->descripcion}}</textarea>
                                    </div>
                                </div>
                            ...
                            <p></p>
                            <a href="{{route('Artista.show', $artista)}}">Cancelar</a>
